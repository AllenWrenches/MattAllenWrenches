...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'index.tpl', 14, false),array('modifier', 'get_extent', 'index.tpl', 185, false),array('block', 'footer_script', 'index.tpl', 27, false),array('function', 'combine_script', 'index.tpl', 84, false),)), $this); ?>
<?php echo $this->_tpl_vars['MENUBAR']; ?>


<?php if (isset ( $this->_tpl_vars['errors'] ) || isset ( $this->_tpl_vars['infos'] )): ?>
<div class="content messages<?php if (isset ( $this->_tpl_vars['MENUBAR'] )): ?> contentWithMenu<?php endif; ?>">
...
?><?php if ($this->_tpl_vars['view']['SELECTED']): ?><?php echo $this->_tpl_vars['view']['CONTENT']; ?>
<?php endif; ?><?php endforeach; endif; unset($_from); ?>
	</a> 
	<div id="calendarViewSwitchBox" class="switchBox">
		<?php $_from = $this->_tpl_vars['chronology_views']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['loop'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['loop']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['view']):
        $this->_foreach['loop']['iteration']++;
?><?php if (! ($this->_foreach['loop']['iteration'] <= 1)): ?><br><?php endif; ?>
		<span<?php if (! $this->_tpl_vars['view']['SELECTED']): ?> style="visibility:hidden"<?php endif; ?>>&#x2714; </span><a href="<?php echo $this->_tpl_vars['view']['VALUE']; ?>
"><?php echo $this->_tpl_vars['view']['CONTENT']; ?>
</a>
<?php endforeach; endif; unset($_from); ?>
	</div>
	<?php $this->_tag_stack[] = array('footer_script', array('require' => 'jquery')); $_block_repeat=true;$this->_plugins['block']['footer_script'][0][0]->block_footer_script($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php echo '
...
<div class="category_search_results"><?php echo Template::mod_translate('Album results for'); ?>
...
<div class="tag_search_results"><?php echo Template::mod_translate('Tag results for'); ?>
 <strong><?php echo $this->_tpl_vars['QUERY_SEARCH']; ?>
</strong> :
	<em><strong>
...
if ($this->_foreach['res_loop']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['tag']):
        $this->_foreach['res_loop']['iteration']++;
?>
	<?php if (! ($this->_foreach['res_loop']['iteration'] <= 1)): ?> &mdash; <?php endif; ?> <a href="<?php echo $this->_tpl_vars['tag']['URL']; ?>
...
<?php endif; ?>
<?php if (! empty ( $this->_tpl_vars['cats_navbar'] )): ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => $this->_plugins['modifier']['get_extent'][0][0]->get_extent('navigation_bar.tpl', 'navbar'), 'smarty_include_vars' => array('navbar' => $this->_tpl_vars['cats_navbar'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
...
<div class="loader"><img src="<?php echo $this->_tpl_vars['ROOT_URL']; ?>
...
<?php endif; ?>
<?php if (! empty ( $this->_tpl_vars['thumb_navbar'] )): ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => $this->_plugins['modifier']['get_extent'][0][0]->get_extent('navigation_bar.tpl', 'navbar'), 'smarty_include_vars' => array('navbar' => $this->_tpl_vars['thumb_navbar'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
