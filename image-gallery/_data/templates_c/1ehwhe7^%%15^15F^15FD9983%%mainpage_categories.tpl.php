...
smarty_core_load_plugins(array('plugins' => array(array('block', 'html_style', 'mainpage_categories.tpl', 1, false),array('block', 'footer_script', 'mainpage_categories.tpl', 10, false),array('function', 'combine_script', 'mainpage_categories.tpl', 18, false),array('modifier', 'replace', 'mainpage_categories.tpl', 25, false),array('modifier', 'strip_tags', 'mainpage_categories.tpl', 25, false),array('modifier', 'translate', 'mainpage_categories.tpl', 25, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('footer_script', array()); $_block_repeat=true;$this->_plugins['block']['footer_script'][0][0]->block_footer_script($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
  var error_icon = "<?php echo $this->_tpl_vars['ROOT_URL']; ?>
<?php echo $this->_tpl_vars['themeconf']['icon_dir']; ?>
/errors_small.png", max_requests = <?php echo $this->_tpl_vars['maxRequests']; ?>
;
...
<?php echo $this->_tpl_vars['themeconf']['icon_dir']; ?>
/img_small.png" data-src="<?php echo $this->_tpl_vars['derivative']->get_url(); ?>
