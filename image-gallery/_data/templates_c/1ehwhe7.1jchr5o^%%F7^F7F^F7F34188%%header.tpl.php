...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'header.tpl', 8, false),array('modifier', 'replace', 'header.tpl', 8, false),array('modifier', 'translate', 'header.tpl', 22, false),array('function', 'combine_css', 'header.tpl', 33, false),array('function', 'get_combined_scripts', 'header.tpl', 44, false),array('function', 'combine_script', 'header.tpl', 49, false),)), $this); ?>
<!DOCTYPE html>
...
<?php endif; ?>
<?php endif; ?>
<title><?php if ($this->_tpl_vars['PAGE_TITLE'] != l10n ( 'Home' ) && $this->_tpl_vars['PAGE_TITLE'] != $this->_tpl_vars['GALLERY_TITLE']): ?><?php echo $this->_tpl_vars['PAGE_TITLE']; ?>
 | <?php endif; ?><?php echo $this->_tpl_vars['GALLERY_TITLE']; ?>
</title>
